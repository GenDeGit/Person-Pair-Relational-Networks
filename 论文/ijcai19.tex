...
\end{equation}
where [.] represents a the operation in the concatenation of vectors. and $\bm{\sigma}$ denoted a sigmoid function. $\bm{w}$ is the parameter to be learn.

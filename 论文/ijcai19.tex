...
What's more, we made analyze PISC and PIPA-relation datasets (\ref{section:dataset_anaysis}), and found that
...
{\bf UnionCNN}  Following \cite{DBLP:conf/eccv/LuKBL16}, it generates a single CNN model to predicate relations. In this task, we also feed the union region of person pair to a single CNN for classification.\\

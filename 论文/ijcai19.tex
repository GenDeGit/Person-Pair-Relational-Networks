...
\begin{figure}[htpb]
  ...
  \subfigure[PISC coarse]{
    \begin{minipage}[t]{0.45\linewidth}
      \centering
      \includegraphics[width=1\linewidth]{pictures/PISC_coarse.png}
    \end{minipage}
  }
  \subfigure[PISC fine]{
    \begin{minipage}[t]{0.45\linewidth}
      \centering
      \includegraphics[width=1\linewidth]{pictures/PISC_fine.png}
    \end{minipage}
  }
  \subfigure[PIPA fine]{
    \begin{minipage}[t]{0.45\linewidth}
      \centering
      \includegraphics[width=1\linewidth]{pictures/PIPA_fine.png}
    \end{minipage}
  }

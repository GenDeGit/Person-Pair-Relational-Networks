...
From the object regions point of view, the effect of object regions is provide the information of scene to constrain the result of the relationship and the information of scene is single. So, object regions is limited for the images with multi-classes social relationships. But, the information of contexual relationships is different that is more appropriate for the fine relationships with multiple scene.
For example, if the object of laptop is useful to classifier the relationship as professional while is not contribute to the relationship of friend, and it's common of such scene with the two relationships.
